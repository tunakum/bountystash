  ...
  return (
    <div className="relative">
      ...
      >
        ...
        <motion.section variants={fadeIn} id="direct-bypass" className="scroll-mt-20">
        ...
        <motion.section variants={fadeIn} id="response-manipulation" className="scroll-mt-20">
          <h2 className="text-2xl font-semibold text-foreground mt-12 mb-4 flex items-center gap-3">
        ...
        <motion.section variants={fadeIn} id="backup-code" className="scroll-mt-20">
          <h2 className="text-2xl font-semibold text-foreground mt-12 mb-4 flex items-center gap-3">
        ...
        <motion.section variants={fadeIn} id="disable-downgrade" className="scroll-mt-20">
          <h2 className="text-2xl font-semibold text-foreground mt-12 mb-4 flex items-center gap-3">
