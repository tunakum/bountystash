  ...
  return (
    <div className="relative">
      ...
      >
        ...
        <motion.section variants={fadeIn} id="localhost" className="scroll-mt-20">
        ...
        <motion.section variants={fadeIn} id="cloud-metadata" className="scroll-mt-20">
          <h2 className="text-2xl font-semibold text-foreground mt-12 mb-4 flex items-center gap-3">
        ...
        <motion.section variants={fadeIn} id="protocol-handlers" className="scroll-mt-20">
          <h2 className="text-2xl font-semibold text-foreground mt-12 mb-4 flex items-center gap-3">
        ...
        <motion.section variants={fadeIn} id="url-bypass" className="scroll-mt-20">
          <h2 className="text-2xl font-semibold text-foreground mt-12 mb-4 flex items-center gap-3">
        ...
        <motion.section variants={fadeIn} id="dns-rebinding" className="scroll-mt-20">
          <h2 className="text-2xl font-semibold text-foreground mt-12 mb-4 flex items-center gap-3">
        ...
        <motion.section variants={fadeIn} id="internal-service" className="scroll-mt-20">
          <h2 className="text-2xl font-semibold text-foreground mt-12 mb-4 flex items-center gap-3">
