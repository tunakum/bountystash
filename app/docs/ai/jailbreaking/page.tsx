  ...
  return (
    <div className="relative">
      ...
      >
        ...
        <motion.section variants={fadeIn} id="role-play" className="scroll-mt-20">
        ...
        <motion.section variants={fadeIn} id="encoding" className="scroll-mt-20">
          <h2 className="text-2xl font-semibold text-foreground mt-12 mb-4 flex items-center gap-3">
        ...
        <motion.section variants={fadeIn} id="multi-turn" className="scroll-mt-20">
          <h2 className="text-2xl font-semibold text-foreground mt-12 mb-4 flex items-center gap-3">
        ...
        <motion.section variants={fadeIn} id="structure" className="scroll-mt-20">
          <h2 className="text-2xl font-semibold text-foreground mt-12 mb-4 flex items-center gap-3">
        ...
        <motion.section variants={fadeIn} id="logic" className="scroll-mt-20">
          <h2 className="text-2xl font-semibold text-foreground mt-12 mb-4 flex items-center gap-3">
